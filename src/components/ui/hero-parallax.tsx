  ...
  return (
    <div className="max-w-7xl relative mx-auto py-20 md:py-40 px-4 w-full left-0 top-0">
      <h1 className="text-4xl md:text-7xl font-bold dark:text-white">
        Apexa AI Labs <br /> limitless growth
      </h1>
      <p className="max-w-2xl text-base md:text-xl mt-8 dark:text-neutral-200">
        We build intelligent automations and custom software to elevate your brand. Let's create something extraordinary together using the latest technologies and frameworks.
      </p>
    </div>
  );
};
